...
const Cookies: FC<Props> = ({ isHidden }) => {
  ...
  return (
    <div style={{ display: 'flex', flexFlow: 'row wrap', fontSize: '0.9rem' }}>
      ...
      <Text size="xs" isFullWidth>Maisha Roots Spain utiliza cookies para proporcionar un uso personalizado al usuario de la Web.</Text>
      ...
      <Accordion title="¿Qué tipos de cookies hay?">
        ...
        <Text size="xs" styles={{ marginBottom: 24 }} isFullWidth>
      ...
      <Accordion title="¿Qué tipos de cookies utiliza Maisha Roots Spain?">
        ...
        <Text size="xs" styles={{ marginBottom: 16 }} isFullWidth>
