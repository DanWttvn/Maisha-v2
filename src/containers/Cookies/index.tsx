  ...
  return (
    <div style={{ display: 'flex', flexFlow: 'row wrap', fontSize: '0.9rem' }}>
      ...
      <Accordion title="¿Qué tipos de cookies hay?">
        <Text size="s" weight="bold" isFullWidth>Según su origen:</Text>
        <ul>
          <li>
        ...
        <Text size="s" weight="bold" isFullWidth>Según el tiempo que permanecen activas:</Text>
        ...
        <Text size="s" weight="bold" isFullWidth>Según su finalidad:</Text>
        <ul>
          <li>
            <Text color="darkGrey" size="s">
      ...
      <Accordion title="¿Qué tipos de cookies utiliza Maisha Roots Spain?">
        <Text size="s" weight="bold" isFullWidth>A. COOKIES PROPIAS</Text>
        <Text size="s" weight="bold" isFullWidth>Cookies de Sesión</Text>
        ...
        <Text size="s" weight="bold" isFullWidth>Cookies Técnicas</Text>
        <Paragraph size="s">
        ...
        <Text size="s" weight="bold" isFullWidth>B. COOKIES DE TERCEROS</Text>
        <Text size="s" weight="bold" isFullWidth>Cookies analíticas</Text>
        <Paragraph size="s">
        ...
        <Text size="s" weight="bold" isFullWidth>Cookies usadas por complementos externos de contenido</Text>
        <Text size="s" styles={{ marginBottom: 16 }} isFullWidth>
      ...
      <Accordion title="¿Cómo puedo desactivar las cookies?">
        ...
        <Text size="s" styles={{ marginBottom: 16 }} isFullWidth>
          A continuación, te indicamos cómo acceder a una cookie determinada del navegador <Text size="s" weight="bold">Chrome</Text> a: estos pasos pueden variar en función de la versión del navegador:
        </Text>
        <ol style={{ marginBottom: 16 }}>
          <li><Text color="darkGrey" size="s">Ve a Configuración o Preferencias mediante el menú Archivo o bien pinchando el icono de personalización que aparece arriba a la derecha.</Text></li>
          <li><Text color="darkGrey" size="s">Verás diferentes secciones, pincha la opción <i>Mostrar opciones avanzadas.</i></Text></li>
          <li><Text color="darkGrey" size="s">Ve a Privacidad, <i>Configuración de contenido.</i></Text></li>
          <li><Text color="darkGrey" size="s">Selecciona <i>Todas las cookies y los datos de sitios.</i></Text></li>
          <li><Text color="darkGrey" size="s">Aparecerá un listado con todas las cookies ordenadas por dominio. Para que te sea más fácil encontrar las cookies de un determinado dominio introduzca parcial o totalmente la dirección en el campo <i>Buscar cookies.</i></Text></li>
          <li><Text color="darkGrey" size="s">Tras realizar este filtro aparecerán en pantalla una o varias líneas con las cookies de la Web solicitada. Ahora sólo tienes que seleccionarla y pulsar la X para proceder a su eliminación.</Text></li>
        </ol>
        <Text size="s" styles={{ marginBottom: 16 }} isFullWidth>
          A continuación, te indicamos cómo acceder a una cookie determinada del navegador <Text size="s" weight="bold">Internet Explorer</Text> a: estos pasos pueden variar en función de la versión del navegador:
        </Text>
        <ol style={{ marginBottom: 16 }}>
          <li><Text color="darkGrey" size="s">Ve a <i>Herramientas, Opciones de Internet</i></Text></li>
          <li><Text color="darkGrey" size="s">Haz clic en <i>Privacidad</i></Text></li>
          <li><Text color="darkGrey" size="s">Mueve el deslizador hasta ajustar el nivel de privacidad que desees.</Text></li>
        </ol>
        <Text size="s" styles={{ marginBottom: 16 }} isFullWidth>
          A continuación, te indicamos cómo acceder a una cookie determinada del navegador <Text size="s" weight="bold">Firefox</Text> a: estos pasos pueden variar en función de la versión del navegador:
        </Text>
        <ol style={{ marginBottom: 16 }}>
          <li><Text color="darkGrey" size="s">Ve a <i>Opciones o Preferencias</i> según tu sistema operativo.</Text></li>
          <li><Text color="darkGrey" size="s">Haz clic en <i>Privacidad</i>.</Text></li>
          <li><Text color="darkGrey" size="s">En <i>Historial</i> elige <i>Usar una configuración personalizada para el historial.</i></Text></li>
          <li><Text color="darkGrey" size="s">Ahora verás la opción <i>Aceptar cookies</i>, puedes activarla o desactivarla según tus preferencias.</Text></li>
        </ol>
        <Text size="s" styles={{ marginBottom: 16 }} isFullWidth>
          A continuación, te indicamos cómo acceder a una cookie determinada del navegador <Text size="s" weight="bold">Safari para OSX</Text> a: estos pasos pueden variar en función de la versión del navegador:
        </Text>
        <ol style={{ marginBottom: 16 }}>
          <li><Text color="darkGrey" size="s">Ve a <i>Preferencias</i>, luego <i>Privacidad</i>.</Text></li>
          <li><Text color="darkGrey" size="s">En este lugar verás la opción <i>Bloquear cookies</i> para que ajuste el tipo de bloqueo que deseas realizar.</Text></li>
        </ol>
        <Text size="s" styles={{ marginBottom: 16 }} isFullWidth>
          A continuación, te indicamos cómo acceder a una cookie determinada del navegador <Text size="s" weight="bold">Safari para iOS</Text> a: estos pasos pueden variar en función de la versión del navegador:
        </Text>
        <ol style={{ marginBottom: 16 }}>
          <li><Text color="darkGrey" size="s">Ve a <i>Ajustes</i>, luego <i>Safari</i>.</Text></li>
          <li><Text color="darkGrey" size="s">Ve a <i>Privacidad y Seguridad</i>, verás la opción <i>Bloquear cookies</i> para que ajuste el tipo de bloqueo que deseas realizar.</Text></li>
        </ol>
        <Text size="s" styles={{ marginBottom: 16 }} isFullWidth>
          A continuación, te indicamos cómo acceder a una cookie determinada del navegador <Text size="s" weight="bold">Android</Text> a: estos pasos pueden variar en función de la versión del navegador:
        </Text>
        <ol style={{ marginBottom: 16 }}>
          <li><Text color="darkGrey" size="s">Ejecuta el navegador y pulsa la tecla <i>Menú</i>, luego <i>Ajustes</i>.</Text></li>
          <li><Text color="darkGrey" size="s">Ve a <i>Seguridad y Privacidad</i>, verás la opción <i>Aceptar cookies</i> para que active o desactive la casilla.</Text></li>
        </ol>
        <Text size="s" styles={{ marginBottom: 16 }} isFullWidth>
          A continuación, te indicamos cómo acceder a una cookie determinada del navegador <Text size="s" weight="bold">Windows Phone</Text> a: estos pasos pueden variar en función de la versión del navegador:
        </Text>
        <ol style={{ marginBottom: 16 }}>
          <li><Text color="darkGrey" size="s">Abre <i>Internet Explorer</i>, luego <i>Más</i>, luego <i>Configuración</i></Text></li>
          <li><Text color="darkGrey" size="s">Ahora puedes activar o desactivar la casilla <i>Permitir cookies.</i></Text></li>
        </ol>
      </Accordion>
    </div>
  )
